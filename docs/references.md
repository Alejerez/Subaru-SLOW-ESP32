...
19. Espressif Systems, *Analog to Digital Converter (ADC) — ESP32*, ESP-IDF Programming Guide. [Online]. Available: https://docs.espressif.com/projects/esp-idf/en/v4.4/esp32/api-reference/peripherals/adc.html *(ADC_ATTEN_DB_11 suggested input range 150–2450 mV — the limit that showed the ignition divider could not be read, and that any future divided input has to respect.)*
