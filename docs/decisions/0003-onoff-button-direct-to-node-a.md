...
- **The OEM switch's pin count is unconfirmed.** De-icer switches sometimes carry
  an integrated indicator lamp, which changes how many pins the physical switch
  has and what each does. This must be measured before wiring. Added as a sixth
